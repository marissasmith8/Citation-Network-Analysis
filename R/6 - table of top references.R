...
#top_refs_table <- read_docx()

#table_doc <- body_add_table(table_doc, top_refs_table)

#print(top_refs_table, target = "outputs/Table of references by times cited.docx")
...
new_table_doc <- body_add_table(new_table_doc, new_numbering[,c(1,2,3:5)])

print(new_table_doc, target = "outputs/Updated PECO JUL.docx")
